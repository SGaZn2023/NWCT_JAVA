...
//            System.out.println("数据已解密");
            System.out.println("get message len: " + decryptMessage.length);
            System.out.println("get message: " + new String(decryptMessage));
...
//            System.out.println("数据加密中");
            System.out.println("send message len: " + bytesRead);
            System.out.println("send message: " + new String(buffer, 0, bytesRead));
