package com.sgz.main.domain;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.sgz.main.obj.MyEncrypt;
import com.sgz.main.obj.ProxyProtocol;
import com.sgz.main.obj.Session;
import com.sgz.main.util.MyIO;
...
//            e.printStackTrace();
    ...
    public synchronized void handleTcpWithEncrypt(Socket localSocket, Socket remoteSocket) {
        try {
            ...
            localSocket.setSendBufferSize(1024 * 64);
            localSocket.setReceiveBufferSize(1024 * 64);
